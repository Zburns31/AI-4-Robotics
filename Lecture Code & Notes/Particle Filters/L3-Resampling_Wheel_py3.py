...
max_weight = max(w)
for i in range(N):
    # Uniform random that's twice as large as the max weight
...
def resample(particles, weights):
    """ Implements the resampling wheel algorithm
    """
    # Code copied from: https://gatech.instructure.com/courses/213570/pages/21-resampling-wheel-answer?module_item_id=1891052
    new_particles = []
